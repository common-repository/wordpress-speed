...
define('W3TC', true);
define('W3TC_VERSION', '1.2.0');
define('W3TC_POWERED_BY', 'WordPress Speed/' . W3TC_VERSION);
...
define('W3TC_README_URL', 'http://plugins.trac.wordpress.org/browser/wordpress-speed/trunk/readme.txt?format=txt');
...
define('W3TC_FILE', 'wordpress-speed/wordpress-speed.php');
...
define('W3TC_BLOGNAMES_PATH', WP_CONTENT_DIR . '/wordpress-speed-blognames.php');
...
define('W3TC_CONFIG_PATH', WP_CONTENT_DIR . '/wordpress-speed-config' . W3TC_SUFFIX . '.php');
define('W3TC_CONFIG_PREVIEW_PATH', WP_CONTENT_DIR . '/wordpress-speed-config' . W3TC_SUFFIX . '-preview.php');
define('W3TC_CONFIG_MASTER_PATH', WP_CONTENT_DIR . '/wordpress-speed-config.php');
