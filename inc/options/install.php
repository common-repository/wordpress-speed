...
# echo '/etc/init.d/memcached' &gt;&gt; /etc/rc.local</pre>
    ...
    <ol>
        ...
        <li>
        	...
        	<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/wordpress-speed/ini/memcache.ini /etc/php.d/</pre>
        </li>
        <li>
...
# whereis apxs</pre>
        ...
        <li>
			...
			<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/wordpress-speed/ini/apc.ini /etc/php.d/</pre>
		</li>
		<li>
    ...
    <ol>
        ...
        <li>
			...
			<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/wordpress-speed/ini/xcache.ini /etc/php.d/</pre>
		</li>
		<li>
			Restart apache when ready:
			<pre class="console"># /etc/init.d/httpd restart</pre>
    ...
    <ol>
        ...
        <li>
        	You can also use the eaccelerator.ini file we prepared for you:
			<pre class="console"># cp /var/www/vhosts/domain.com/httpdocs/wp-content/plugins/wordpress-speed/ini/eaccelerator.ini /etc/php.d/</pre>
		</li>
		<li>
			Restart apache when ready:
			<pre class="console"># /etc/init.d/httpd restart</pre>
