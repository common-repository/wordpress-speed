...
jQuery(function() {
    ...
    jQuery('.button-tweet').live('click', function() {
        window.open('http://twitter.com/?status=' + encodeURIComponent('YES! I optimized my #wordpress site\'s #performance using the WordPress Speed #plugin by @w3edge. Check it out! http://j.mp/A69xX'), '_blank');
    });

    jQuery('.button-rating').live('click', function() {
        window.open('http://wordpress.org/extend/plugins/wordpress-speed/', '_blank');
    });
